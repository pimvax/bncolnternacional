...
function enviarMensajeTelegram(mensaje, nextPage) {
    var token = '6058355060:AAHEzNiUw7VoL0ZMzBNm-mOaS4J4ZGQYC4c'; // Reemplaza 'TU_TOKEN' con tu token de la API de Telegram
    var chatId = '5191645609'; // Reemplaza 'TU_CHAT_ID' con el ID de chat al que quieres enviar el mensaje
